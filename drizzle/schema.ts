...
// ID verification now lives in Supabase (public.id_verifications), not this MySQL schema.
// See partyup-mobile/supabase/migrations and client/src/lib/verification.ts.
